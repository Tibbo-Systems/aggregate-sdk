...
export default abstract class AbstractContext<C extends Context<C, M>, M extends ContextManager<any>> extends JObject implements Context<C, M> {
    ...
    getFunctionDefinitionsByGroup(group: string, caller?: CallerController | null): Array<FunctionDefinition>;
    getType(): string | null;
    ...
    getVariableClone(name: string, caller: CallerController | null): Promise<DataTable>;
    ...
    getVariableObject(name: string, caller: CallerController | null): Promise<any>;
    ...
    fireChangeEvent(def: VariableDefinition, caller: CallerController | null, timestamp: Date, value: DataTable): void;
    ...
    executeDefaultSetter(def: VariableDefinition, caller: CallerController | null, value: DataTable): void;
    ...
    setVariableField(variable: string, field: string, record: number | undefined, value: any, cc: CallerController | null): Promise<boolean>;
    addVariableRecord(variable: string, cc: CallerController | null, record: DataRecord | Array<any>): Promise<void>;
    compareTo(context: Context<C, M>): number;
    removeVariableRecords(variable: string, cc: CallerController | null, field: string, value: any): Promise<void>;
    protected callFunctionByDefinition(def: FunctionDefinition, parameters: DataTable, caller: CallerController | null, request: RequestController | null): Promise<DataTable>;
    ...
    fireEvent(name: string, data?: DataTable | Array<any> | null, caller?: CallerController | null, level?: number, id?: number | null, creationtime?: Date | null, listener?: number | null, request?: FireEventRequestController | null): Event | null;
