...
export default interface Context<C extends Context<any, any>, M extends ContextManager<any>> {
     ...
     */
    setVariable(name: string, value: DataTable, caller: CallerController | null, request: RequestController | null): Promise<void>;
     ...
     */
    callFunction(name: string, parameters: DataTable | Array<any> | null, caller: CallerController | null, request: RequestController | null): Promise<DataTable>;
    /**
     * Fires context event.
     *
     * @return Event object or null if event was suppressed by context.
     */
    fireEvent(name: string, data: DataTable | null, caller: CallerController, level: number, id: number | null, creationtime: Date | null, listener: number | null, request: FireEventRequestController | null): Event | null;
    /**
