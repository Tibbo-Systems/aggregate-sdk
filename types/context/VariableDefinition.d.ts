...
export default class VariableDefinition extends AbstractEntityDefinition implements Comparable<VariableDefinition> {
    ...
    setSetter(setter: (con: Context<any, any>, def: VariableDefinition, caller: CallerController | null, request: RequestController | null, value: DataTable) => boolean): void;
    setGetter(getter: (con: Context<any, any>, def: VariableDefinition, caller: CallerController | null, request: RequestController | null) => DataTable): void;
    ...
    getSetter(): ((con: Context<any, any>, def: VariableDefinition, caller: CallerController | null, request: RequestController | null, value: DataTable) => boolean) | null;
    getGetter(): ((con: Context<any, any>, def: VariableDefinition, caller: CallerController | null, request: RequestController | null) => DataTable) | null;
