...
export default class ProxyContext<C extends Context<C, M>, M extends ContextManager<any>> extends AbstractContext<C, M> {
    ...
    init(): Promise<Context<any, any>>;
    setupMyself(): void;
    private addListenersOnInfo;
    private addListenersOnActions;
    private addListenersOnEvents;
    private addListenersOnFunctions;
    private addListenersOnVariables;
    private addListenersOnChildren;
