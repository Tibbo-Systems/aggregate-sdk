import AbstractEvaluatingVisitor from "../../src/expression/AbstractEvaluatingVisitor";
import DumperVisitor from "../../src/expression/DumperVisitor";

describe('ExpressionVisitor', () => {


    it('testVisitor', async done => {
        ...
        const visitor2 = new AbstractEvaluatingVisitor();
        visitor2.visitCompilationUnit(tree);
