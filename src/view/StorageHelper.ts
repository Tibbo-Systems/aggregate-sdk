...
export default class StorageHelper {
  ...
  public static FIELD_COLUMNS_NAME: string = 'name';
  ...
  static __static_initializer_0() {
    StorageHelper.FIFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FIF_STORAGE_OPEN_ID + '><L><F=N><D=' + Cres.get().getString('id') + '>'
    );
    StorageHelper.FIFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FIF_STORAGE_OPEN_VIEW + '><S><F=N><D=' + Cres.get().getString('view') + '>'
    );
    StorageHelper.FIFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FIF_STORAGE_OPEN_QUERY + '><S><F=N><D=' + Cres.get().getString('query') + '>'
    );
    StorageHelper.FIFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FIF_STORAGE_OPEN_TABLE + '><S><F=N><D=' + Cres.get().getString('table') + '>'
    );
    StorageHelper.FIFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FIF_STORAGE_OPEN_COLUMNS + '><T><F=N><D=' + Cres.get().getString('columns') + '>'
    );
    StorageHelper.FIFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FIF_STORAGE_OPEN_FILTER + '><T><F=N><D=' + Cres.get().getString('filter') + '>'
    );
    StorageHelper.FIFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FIF_STORAGE_OPEN_SORTING + '><T><F=N><D=' + Cres.get().getString('sorting') + '>'
    );
    StorageHelper.FIFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FIF_STORAGE_OPEN_GET_DATA + '><B><D=' + Cres.get().getString('getData') + '>'
    );
    StorageHelper.FIFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FIF_STORAGE_OPEN_LIMIT + '><I><F=N><D=' + Cres.get().getString('limit') + '>'
    );
    StorageHelper.FIFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FIF_STORAGE_OPEN_OFFSET + '><I><F=N><D=' + Cres.get().getString('offSet') + '>'
    );
  }
  ...
  static __static_initializer_1() {
    StorageHelper.FOFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FOF_STORAGE_OPEN_ID + '><L><D=' + Cres.get().getString('id') + '>'
    );
    StorageHelper.FOFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FOF_STORAGE_OPEN_COUNT + '><I><F=N><D=' + Cres.get().getString('count') + '>'
    );
    StorageHelper.FOFT_STORAGE_OPEN.addField(
      '<' + StorageHelper.FOF_STORAGE_OPEN_DATA + '><T><F=N><D=' + Cres.get().getString('data') + '>'
    );
  }
  ...
  static __static_initializer_2() {
    StorageHelper.FIFT_STORAGE_CLOSE.addField(
      '<' + StorageHelper.FIF_STORAGE_CLOSE_ID + '><L><D=' + Cres.get().getString('id') + '>'
    );
  }
  ...
  static __static_initializer_3() {
    StorageHelper.FIFT_STORAGE_GET.addField(
      '<' + StorageHelper.FIF_STORAGE_GET_ID + '><L><D=' + Cres.get().getString('id') + '>'
    );
    StorageHelper.FIFT_STORAGE_GET.addField(
      '<' + StorageHelper.FIF_STORAGE_GET_FIRST + '><I><D=' + Cres.get().getString('first') + '>'
    );
    StorageHelper.FIFT_STORAGE_GET.addField(
      '<' + StorageHelper.FIF_STORAGE_GET_COUNT + '><I><D=' + Cres.get().getString('count') + '>'
    );
  }
  ...
  static __static_initializer_4() {
    StorageHelper.FOFT_STORAGE_GET.addField(
      '<' + StorageHelper.FOF_STORAGE_GET_SIZE + '><I><F=N><D=' + Cres.get().getString('size') + '>'
    );
    StorageHelper.FOFT_STORAGE_GET.addField(
      '<' + StorageHelper.FOF_STORAGE_GET_DATA + '><T><F=N><D=' + Cres.get().getString('data') + '>'
    );
  }
  ...
  static __static_initializer_5() {
    StorageHelper.FIFT_STORAGE_UPDATE.addField(
      '<' + StorageHelper.FIF_STORAGE_UPDATE_ID + '><L><F=N><D=' + Cres.get().getString('id') + '>'
    );
    StorageHelper.FIFT_STORAGE_UPDATE.addField(
      '<' + StorageHelper.FIF_STORAGE_UPDATE_ROW + '><I><F=N><D=' + Cres.get().getString('row') + '>'
    );
    StorageHelper.FIFT_STORAGE_UPDATE.addField(
      '<' + StorageHelper.FIF_STORAGE_UPDATE_COLUMN + '><S><D=' + Cres.get().getString('column') + '>'
    );
    StorageHelper.FIFT_STORAGE_UPDATE.addField(
      '<' + StorageHelper.FIF_STORAGE_UPDATE_VALUE + '><T><D=' + Cres.get().getString('value') + '>'
    );
    StorageHelper.FIFT_STORAGE_UPDATE.addField(
      '<' + StorageHelper.FIF_STORAGE_UPDATE_TABLE + '><S><F=N><D=' + Cres.get().getString('table') + '>'
    );
    StorageHelper.FIFT_STORAGE_UPDATE.addField(
      '<' + StorageHelper.FIF_STORAGE_UPDATE_FILTER + '><T><F=N><D=' + Cres.get().getString('filter') + '>'
    );
  }
  ...
  static __static_initializer_6() {
    StorageHelper.FOFT_STORAGE_UPDATE.addField(
      '<' + StorageHelper.FOF_STORAGE_UPDATE_COUNT + '><I><D=' + Cres.get().getString('count') + '>'
    );
  }
  ...
  static __static_initializer_7() {
    StorageHelper.FIFT_STORAGE_DELETE.addField(
      '<' + StorageHelper.FIF_STORAGE_DELETE_ID + '><L><F=N><D=' + Cres.get().getString('id') + '>'
    );
    StorageHelper.FIFT_STORAGE_DELETE.addField(
      '<' + StorageHelper.FIF_STORAGE_DELETE_ROWLIST + '><T><F=N><D=' + Cres.get().getString('rowList') + '>'
    );
    StorageHelper.FIFT_STORAGE_DELETE.addField(
      '<' + StorageHelper.FIF_STORAGE_DELETE_TABLE + '><S><F=N><D=' + Cres.get().getString('table') + '>'
    );
    StorageHelper.FIFT_STORAGE_DELETE.addField(
      '<' + StorageHelper.FIF_STORAGE_DELETE_FILTER + '><T><F=N><D=' + Cres.get().getString('filter') + '>'
    );
  }
  ...
  static __static_initializer_8() {
    StorageHelper.FOFT_STORAGE_DELETE.addField(
      '<' + StorageHelper.FOF_STORAGE_DELETE_COUNT + '><I><D=' + Cres.get().getString('count') + '>'
    );
  }
  ...
  static __static_initializer_9() {
    StorageHelper.FIFT_STORAGE_INSERT.addField(
      '<' + StorageHelper.FIF_STORAGE_INSERT_ID + '><L><F=N><D=' + Cres.get().getString('id') + '>'
    );
    StorageHelper.FIFT_STORAGE_INSERT.addField(
      '<' + StorageHelper.FIF_STORAGE_INSERT_VALUES + '><T><D=' + Cres.get().getString('values') + '>'
    );
    StorageHelper.FIFT_STORAGE_INSERT.addField(
      '<' + StorageHelper.FIF_STORAGE_INSERT_TABLE + '><S><F=N><D=' + Cres.get().getString('table') + '>'
    );
  }
  ...
  static __static_initializer_10() {
    StorageHelper.FOFT_STORAGE_INSERT.addField(
      '<' + StorageHelper.FOF_STORAGE_INSERT_INSTANCE_ID + '><S><D=' + Cres.get().getString('instanceId') + '>'
    );
  }
  ...
  static __static_initializer_11() {
    StorageHelper.FIFT_STORAGE_COLUMNS.addField(
      '<' + StorageHelper.FIF_STORAGE_COLUMNS_TABLE + '><S><D=' + Cres.get().getString('table') + '>'
    );
    StorageHelper.FIFT_STORAGE_COLUMNS.addField(
      '<' + StorageHelper.FIF_STORAGE_COLUMNS_COLUMNS + '><T><D=' + Cres.get().getString('columns') + '>'
    );
    StorageHelper.FIFT_STORAGE_COLUMNS.addField(
      FieldFormatFactory.createType(
        StorageHelper.FIF_STORAGE_COLUMNS_LIFE_CYCLES,
  ...
  static __static_initializer_12() {
    StorageHelper.FIFT_STORAGE_RELATIONS.addField(
      '<' + StorageHelper.FIF_STORAGE_RELATIONS_TABLE + '><S><D=' + Cres.get().getString('table') + '>'
    );
  ...
  static __static_initializer_13() {
    StorageHelper.FIFT_STORAGE_FILTER.addField(
      '<' + StorageHelper.FIF_STORAGE_FILTER_TABLE + '><S><D=' + Cres.get().getString('table') + '>'
    );
    StorageHelper.FIFT_STORAGE_FILTER.addField(
      '<' + StorageHelper.FIF_STORAGE_FILTER_FILTER + '><T><D=' + Cres.get().getString('filter') + '>'
    );
  }
  ...
  static __static_initializer_14() {
    StorageHelper.FIFT_STORAGE_SORTING.addField(
      '<' + StorageHelper.FIF_STORAGE_SORTING_TABLE + '><S><D=' + Cres.get().getString('table') + '>'
    );
    StorageHelper.FIFT_STORAGE_SORTING.addField(
      '<' + StorageHelper.FIF_STORAGE_SORTING_SORTING + '><T><D=' + Cres.get().getString('sorting') + '>'
    );
  }
  ...
  static __static_initializer_15() {
    StorageHelper.FIFT_STORAGE_CONSTRUCT.addField(
      '<' + StorageHelper.FIF_STORAGE_CONSTRUCT_TABLE + '><S><D=' + Cres.get().getString('table') + '>'
    );
    StorageHelper.FIFT_STORAGE_CONSTRUCT.addField(
      '<' + StorageHelper.FIF_STORAGE_CONSTRUCT_FIELDS + '><T><F=N><D=' + Cres.get().getString('fields') + '>'
    );
    StorageHelper.FIFT_STORAGE_CONSTRUCT.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_CONSTRUCT_LIFE_CYCLES,
        FieldConstants.DATATABLE_FIELD,
        Cres.get().getString('lifeCycles')
      ).setNullable(true)
    );
    StorageHelper.FIFT_STORAGE_CONSTRUCT.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_MANY_TO_MANY_RELATIONS,
        FieldConstants.DATATABLE_FIELD,
        Cres.get().getString('classManyToManyRelations')
      ).setNullable(true)
    );
  }
  ...
  static __static_initializer_16() {
    StorageHelper.FIFT_STORAGE_OPERATIONS.addField(
      '<' + StorageHelper.FIF_STORAGE_OPERATIONS_TABLE + '><S><D=' + Cres.get().getString('table') + '>'
    );
    StorageHelper.FIFT_STORAGE_OPERATIONS.addField(
      '<' + StorageHelper.FIF_STORAGE_OPERATIONS_COLUMN + '><S><D=' + Cres.get().getString('column') + '>'
    );
  }
  ...
  static __static_initializer_17() {
    StorageHelper.FIFT_STORAGE_CONSTRUCT_RELATION.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_CONSTRUCT_RELATION_TABLE,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('table')
      )
    );
    StorageHelper.FIFT_STORAGE_CONSTRUCT_RELATION.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_CONSTRUCT_RELATION_PRIMARY_KEY_TYPE,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('primaryKeyType')
      )
    );
    StorageHelper.FIFT_STORAGE_CONSTRUCT_RELATION.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_CONSTRUCT_RELATION_RELATED_TABLE,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('relatedTable')
      )
    );
    StorageHelper.FIFT_STORAGE_CONSTRUCT_RELATION.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_CONSTRUCT_RELATION_RELATED_PRIMARY_KEY_TYPE,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('relatedPrimaryKeyType')
      )
    );
    StorageHelper.FIFT_STORAGE_CONSTRUCT_RELATION.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_CONSTRUCT_RELATION_NAME,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('relationName')
      )
    );
    StorageHelper.FIFT_STORAGE_CONSTRUCT_RELATION.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_CONSTRUCT_RELATION_CASCADE_DELETE,
        FieldConstants.BOOLEAN_FIELD,
        Cres.get().getString('classManyToManyCascadeDelete')
      )
    );
  }
  ...
  static __static_initializer_18() {
    StorageHelper.FIFT_STORAGE_DELETE_RELATION.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_DELETE_RELATION_TABLE,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('table')
      )
    );
    ...
    StorageHelper.FIFT_STORAGE_DELETE_RELATION.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_DELETE_RELATION_RELATED_TABLE,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('relatedTable')
      )
    );
    ...
    StorageHelper.FIFT_STORAGE_DELETE_RELATION.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_DELETE_RELATION_NAME,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('relationName')
      )
    );
  ...
  static __static_initializer_19() {
    StorageHelper.FORMAT_RELATED_IDS.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINK_INSTANCES_INSTANCE_ID,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('instanceId')
      )
    );
    StorageHelper.FORMAT_RELATED_IDS.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINK_INSTANCES_RELATED_ID,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('relatedId')
      )
    );
  }
  ...
  static __static_initializer_20() {
    StorageHelper.FIFT_STORAGE_LINK_INSTANCES.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINK_INSTANCES_TABLE,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('table')
      )
    );
    StorageHelper.FIFT_STORAGE_LINK_INSTANCES.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINK_INSTANCES_RELATED_TABLE,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('relatedTable')
      )
    );
    StorageHelper.FIFT_STORAGE_LINK_INSTANCES.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINK_INSTANCES_RELATION_NAME,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('relationName')
      )
    );
    StorageHelper.FIFT_STORAGE_LINK_INSTANCES.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINK_INSTANCES_RELATED_IDS,
        FieldConstants.DATATABLE_FIELD,
        Cres.get().getString('relatedIds')
      )
    );
  }
  ...
  static __static_initializer_21() {
    StorageHelper.FIFT_STORAGE_LINKED_INSTANCES_FILTER.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINKED_INSTANCES_FILTER_INSTANCE_ID,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('instanceId')
      )
    );
    StorageHelper.FIFT_STORAGE_LINKED_INSTANCES_FILTER.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINKED_INSTANCES_FILTER_TABLE,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('table')
      )
    );
    StorageHelper.FIFT_STORAGE_LINKED_INSTANCES_FILTER.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINKED_INSTANCES_FILTER_RELATED_TABLE,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('relatedTable')
      )
    );
    StorageHelper.FIFT_STORAGE_LINKED_INSTANCES_FILTER.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINKED_INSTANCES_FILTER_RELATION_NAME,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('relationName')
      )
    );
    StorageHelper.FIFT_STORAGE_LINKED_INSTANCES_FILTER.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINKED_INSTANCES_FILTER_RELATION_OWNER,
        FieldConstants.BOOLEAN_FIELD,
        Cres.get().getString('relationOwner')
      )
    );
    StorageHelper.FIFT_STORAGE_LINKED_INSTANCES_FILTER.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_LINKED_INSTANCES_FILTER_GET_RELATED,
        FieldConstants.BOOLEAN_FIELD,
        Cres.get().getString('getRelated')
      )
    );
  }
  ...
  static __static_initializer_22() {
    StorageHelper.FIFT_STORAGE_GET_FORMAT.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_GET_FORMAT_TABLE,
        FieldConstants.STRING_FIELD,
        Cres.get().getString('table'),
        null,
        true
    ...
    StorageHelper.FIFT_STORAGE_GET_FORMAT.addField(
      FieldFormatFactory.createWith(
        StorageHelper.FIF_STORAGE_GET_FORMAT_VIEW,
        FieldConstants.STRING_FIELD,
  ...
  static __static_initializer_23() {
    StorageHelper.FORMAT_COLUMNS.addField(
      '<' + StorageHelper.FIELD_COLUMNS_NAME + '><S><F=EK><D=' + Cres.get().getString('name') + '>'
    );
    StorageHelper.FORMAT_COLUMNS.addField(
      '<' + StorageHelper.FIELD_COLUMNS_DESCRIPTION + '><S><F=R><D=' + Cres.get().getString('description') + '>'
    );
    StorageHelper.FORMAT_COLUMNS.addField(
      '<' + StorageHelper.FIELD_COLUMNS_GROUP + '><S><D=' + Cres.get().getString('group') + '>'
    );

    const ff: FieldFormat<any> = FieldFormatFactory.createWith(
      StorageHelper.FIELD_COLUMNS_VISIBILITY,
      FieldConstants.INTEGER_FIELD,
      Cres.get().getString('visibility'),
      StorageHelper.VISIBILITY_VISIBLE
    );
    ...
    StorageHelper.FORMAT_COLUMNS.addField(
      '<' + StorageHelper.FIELD_COLUMNS_READONLY + '><B><A=0><D=' + Cres.get().getString('readOnly') + '>'
    );
    StorageHelper.FORMAT_COLUMNS.addField(
      '<' + StorageHelper.FIELD_COLUMNS_PRIMARY_KEY + '><B><F=R><A=0><D=' + Cres.get().getString('primaryKey') + '>'
    );
    ...
    StorageHelper.FORMAT_COLUMNS.addField(
      FieldFormatFactory.createWith(
        ...
        FieldConstants.BOOLEAN_FIELD,
        Cres.get().getString('isCalculatedField')
      ).setDefault(false)
    );
    StorageHelper.FORMAT_COLUMNS.addField(
      FieldFormatFactory.createWith(
        ...
        FieldConstants.DATATABLE_FIELD,
        Cres.get().getString('fieldColumnDataTable')
      )
        .setNullable(true)
        .setDefault(null)
    );

    StorageHelper.FORMAT_COLUMNS.setNamingExpression(
      Functions.PRINT +
        '({}, "{' +
        StorageHelper.FIELD_COLUMNS_VISIBILITY +
        '} ? {' +
        StorageHelper.FIELD_COLUMNS_NAME +
        '} : null", ", ")'
    );
    StorageHelper.FORMAT_COLUMNS.addBinding(
      StorageHelper.FIELD_COLUMNS_FIELD_DATATABLE + '#' + DataTableBindingProvider.PROPERTY_ENABLED,
      '{' + StorageHelper.FIELD_COLUMNS_IS_CALCULATED_FIELD + '}'
    );
    StorageHelper.FORMAT_COLUMNS.addBinding(
      StorageHelper.FIELD_COLUMNS_FIELD_DATATABLE,
    ...
    StorageHelper.FORMAT_COLUMNS.addBinding(
      StorageHelper.FIELD_COLUMNS_NAME + '#' + DataTableBindingProvider.PROPERTY_ENABLED,
      '{' + StorageHelper.FIELD_COLUMNS_IS_CALCULATED_FIELD + '}'
    );
  }
  ...
  static __static_initializer_24() {
    StorageHelper.FORMAT_SORTING.addField(
      '<' + StorageHelper.FIELD_SORTING_COLUMN + '><S><F=E><D=' + Cres.get().getString('viewColumnOrExpression') + '>'
    );

    const ff: FieldFormat<any> = FieldFormatFactory.create(
      '<' + StorageHelper.FIELD_SORTING_ORDER + '><I><D=' + Cres.get().getString('sortOrder') + '>'
    );
    ...
    StorageHelper.FORMAT_SORTING.setNamingExpression(
      Functions.PRINT +
        '({}, "{' +
        StorageHelper.FIELD_SORTING_COLUMN +
        "} + ' ' + {" +
        StorageHelper.FIELD_SORTING_ORDER +
        '#' +
  ...
  static __static_initializer_25() {
    StorageHelper.FORMAT_ROWLIST.addField(
      FieldFormatFactory.createWith('row', FieldConstants.INTEGER_FIELD, Cres.get().getString('row'))
    );
  }
  ...
  static __static_initializer_26() {
    StorageHelper.FOFT_ADD_ROW_ACTION.addField(
      FieldFormatFactory.createType(EditData.CF_STORAGE_CONTEXT, FieldConstants.STRING_FIELD)
    );
  }
  ...
  static __static_initializer_27() {
    StorageHelper.FOFT_REMOVE_OR_UPDATE_ROW_ACTION.addField(
      FieldFormatFactory.createType(EditData.CF_INLUDE_RECORD, FieldConstants.BOOLEAN_FIELD).setDefault(true)
    );
    StorageHelper.FOFT_REMOVE_OR_UPDATE_ROW_ACTION.addField(
      FieldFormatFactory.createType(EditData.CF_STORAGE_CONTEXT, FieldConstants.STRING_FIELD).setNullable(true)
    );
    StorageHelper.FOFT_REMOVE_OR_UPDATE_ROW_ACTION.addField(
      FieldFormatFactory.createType(EditData.CF_RECORD_INDEX, FieldConstants.INTEGER_FIELD).setNullable(true)
    );
    StorageHelper.FOFT_REMOVE_OR_UPDATE_ROW_ACTION.addField(
      FieldFormatFactory.createType(StorageHelper.CLASS_FIELD_INSTANCE_ID, FieldConstants.LONG_FIELD).setNullable(true)
    );
    StorageHelper.FOFT_REMOVE_OR_UPDATE_ROW_ACTION.addField(
      FieldFormatFactory.createType(EditData.CF_RECORD_DESCRIPTION, FieldConstants.STRING_FIELD).setNullable(true)
    );
  }

  private static readonly GROUP_STORAGE: string = ContextUtils.createGroup(
    ContextUtilsConstants.GROUP_DEFAULT,
    Cres.get().getString('storage')
  );

  public static FD_STORAGE_OPEN: FunctionDefinition;
  static __static_initializer_28() {
    StorageHelper.FD_STORAGE_OPEN = new FunctionDefinition(
      StorageHelper.F_STORAGE_OPEN,
      StorageHelper.FIFT_STORAGE_OPEN,
      StorageHelper.FOFT_STORAGE_OPEN,
      Cres.get().getString('storageOpen'),
      StorageHelper.GROUP_STORAGE
    );
  }

  public static FD_STORAGE_CLOSE: FunctionDefinition;
  static __static_initializer_29() {
    StorageHelper.FD_STORAGE_CLOSE = new FunctionDefinition(
      StorageHelper.F_STORAGE_CLOSE,
      StorageHelper.FIFT_STORAGE_CLOSE,
      TableFormat.EMPTY_FORMAT,
      Cres.get().getString('storageClose'),
      StorageHelper.GROUP_STORAGE
    );
  }
  ...
  static __static_initializer_30() {
    StorageHelper.FD_STORAGE_GET = new FunctionDefinition(
      StorageHelper.F_STORAGE_GET,
      StorageHelper.FIFT_STORAGE_GET,
      StorageHelper.FOFT_STORAGE_GET,
      Cres.get().getString('storageGet'),
      StorageHelper.GROUP_STORAGE
    );
  }
  ...
  static __static_initializer_31() {
    StorageHelper.FD_STORAGE_UPDATE = new FunctionDefinition(
      StorageHelper.F_STORAGE_UPDATE,
      StorageHelper.FIFT_STORAGE_UPDATE,
      StorageHelper.FOFT_STORAGE_UPDATE,
      Cres.get().getString('storageUpdate'),
      StorageHelper.GROUP_STORAGE
    );
  }
  ...
  static __static_initializer_32() {
    StorageHelper.FD_STORAGE_DELETE = new FunctionDefinition(
      StorageHelper.F_STORAGE_DELETE,
      StorageHelper.FIFT_STORAGE_DELETE,
      StorageHelper.FOFT_STORAGE_DELETE,
      Cres.get().getString('storageDelete'),
      StorageHelper.GROUP_STORAGE
    );
  }
  ...
  static __static_initializer_33() {
    StorageHelper.FD_STORAGE_INSERT = new FunctionDefinition(
      StorageHelper.F_STORAGE_INSERT,
      StorageHelper.FIFT_STORAGE_INSERT,
      StorageHelper.FOFT_STORAGE_INSERT,
      Cres.get().getString('storageInsert'),
      StorageHelper.GROUP_STORAGE
    );
  }
  ...
  static __static_initializer_34() {
    StorageHelper.FD_STORAGE_VIEWS = new FunctionDefinition(
      StorageHelper.F_STORAGE_VIEWS,
      TableFormat.EMPTY_FORMAT,
      DataTableBuilding.SELECTION_VALUES_FORMAT,
      Cres.get().getString('storageViews'),
      StorageHelper.GROUP_STORAGE
    );
  }
  ...
  static __static_initializer_35() {
    StorageHelper.FD_STORAGE_TABLES = new FunctionDefinition(
      StorageHelper.F_STORAGE_TABLES,
      TableFormat.EMPTY_FORMAT,
      DataTableBuilding.SELECTION_VALUES_FORMAT,
      Cres.get().getString('storageTables'),
      StorageHelper.GROUP_STORAGE
    );
  }
  ...
  static __static_initializer_36() {
    StorageHelper.FD_STORAGE_COLUMNS = new FunctionDefinition(
      StorageHelper.F_STORAGE_COLUMNS,
      StorageHelper.FIFT_STORAGE_COLUMNS,
      StorageHelper.FORMAT_COLUMNS,
      Cres.get().getString('storageColumns'),
      StorageHelper.GROUP_STORAGE
    );
  }
  ...
  static __static_initializer_37() {
    StorageHelper.FD_STORAGE_RELATIONS = new FunctionDefinition(
      StorageHelper.F_STORAGE_RELATIONS,
      StorageHelper.FIFT_STORAGE_RELATIONS,
      StorageHelper.FORMAT_COLUMNS
    );
  }
  ...
  static __static_initializer_38() {
    StorageHelper.FD_STORAGE_FILTER = new FunctionDefinition(
      StorageHelper.F_STORAGE_FILTER,
      StorageHelper.FIFT_STORAGE_FILTER,
      null
    );
  }
  ...
  static __static_initializer_39() {
    StorageHelper.FD_STORAGE_SORTING = new FunctionDefinition(
      StorageHelper.F_STORAGE_SORTING,
      StorageHelper.FIFT_STORAGE_SORTING,
      null
    );
  }
  ...
  static __static_initializer_40() {
    StorageHelper.FD_STORAGE_CONSTRUCT = new FunctionDefinition(
      StorageHelper.F_STORAGE_CONSTRUCT,
      StorageHelper.FIFT_STORAGE_CONSTRUCT,
      TableFormat.EMPTY_FORMAT
    );
  }
  ...
  static __static_initializer_41() {
    StorageHelper.FD_STORAGE_OPERATIONS = new FunctionDefinition(
      StorageHelper.F_STORAGE_OPERATIONS,
      StorageHelper.FIFT_STORAGE_OPERATIONS,
      DataTableBuilding.SELECTION_VALUES_FORMAT
    );
  }
  ...
  static __static_initializer_42() {
    StorageHelper.FD_STORAGE_CONSTRUCT_RELATION = new FunctionDefinition(
      StorageHelper.F_STORAGE_CONSTRUCT_RELATION,
      StorageHelper.FIFT_STORAGE_CONSTRUCT_RELATION,
      TableFormat.EMPTY_FORMAT
    );
  }
  ...
  static __static_initializer_43() {
    StorageHelper.FD_STORAGE_DELETE_RELATION = new FunctionDefinition(
      StorageHelper.F_STORAGE_DELETE_RELATION,
      StorageHelper.FIFT_STORAGE_DELETE_RELATION,
      TableFormat.EMPTY_FORMAT
    );
  }
  ...
  static __static_initializer_44() {
    StorageHelper.FD_STORAGE_LINK_INSTANCES = new FunctionDefinition(
      StorageHelper.F_STORAGE_LINK_INSTANCES,
      StorageHelper.FIFT_STORAGE_LINK_INSTANCES,
      TableFormat.EMPTY_FORMAT
    );
  }
  ...
  static __static_initializer_45() {
    StorageHelper.FD_STORAGE_UNLINK_INSTANCES = new FunctionDefinition(
      StorageHelper.F_STORAGE_UNLINK_INSTANCES,
      StorageHelper.FIFT_STORAGE_UNLINK_INSTANCES,
      TableFormat.EMPTY_FORMAT
    );
  }
  ...
  static __static_initializer_46() {
    StorageHelper.FD_STORAGE_LINKED_INSTANCES_FILTER = new FunctionDefinition(
      StorageHelper.F_STORAGE_LINKED_INSTANCES_FILTER,
      StorageHelper.FIFT_STORAGE_LINKED_INSTANCES_FILTER,
      StorageHelper.FOFT_STORAGE_LINKED_INSTANCES_FILTER
    );
  }

  public static FD_STORAGE_GET_FORMAT: FunctionDefinition;
  static __static_initializer_47() {
    StorageHelper.FD_STORAGE_GET_FORMAT = new FunctionDefinition(
      StorageHelper.F_STORAGE_GET_FORMAT,
      StorageHelper.FIFT_STORAGE_GET_FORMAT,
      null,
      Cres.get().getString('storageGetFormat'),
      StorageHelper.GROUP_STORAGE
    );
  }
  ...
  static __static_initializer_48() {
    StorageHelper.EFT_CLASS_INSTANCE_CREATED.addField(
      FieldFormatFactory.createType(StorageHelper.FIELD_EVENT_INSTANCE_ID, FieldConstants.STRING_FIELD)
    );
    StorageHelper.EFT_CLASS_INSTANCE_CREATED.addField(
      FieldFormatFactory.createType(
        StorageHelper.FIELD_EVENT_INSTANCE_DESCRIPTION,
        FieldConstants.STRING_FIELD
      ).setNullable(true)
    );
    StorageHelper.EFT_CLASS_INSTANCE_CREATED.addField(
      FieldFormatFactory.createType(
        StorageHelper.FIELD_EVENT_MODIFICATION_AUTHOR,
        FieldConstants.STRING_FIELD
      ).setNullable(true)
    );
  }
  ...
  static __static_initializer_49() {
    StorageHelper.EFT_CLASS_INSTANCE_DELETED.addField(
      FieldFormatFactory.createType(StorageHelper.FIELD_EVENT_INSTANCE, FieldConstants.DATATABLE_FIELD).setNullable(
        true
      )
    );
  }
  ...
  static __static_initializer_50() {
    StorageHelper.EFT_CLASS_INSTANCE_CHANGED.addField(
      FieldFormatFactory.createType(StorageHelper.FIELD_EVENT_FIELD_NAME, FieldConstants.STRING_FIELD)
    );
    StorageHelper.EFT_CLASS_INSTANCE_CHANGED.addField(
      FieldFormatFactory.createType(
        StorageHelper.FIELD_EVENT_FIELD_DESCRIPTION,
        FieldConstants.STRING_FIELD
      ).setNullable(true)
    );
    StorageHelper.EFT_CLASS_INSTANCE_CHANGED.addField(
      FieldFormatFactory.createType(StorageHelper.FIELD_EVENT_OLD_VALUE, FieldConstants.STRING_FIELD).setNullable(true)
    );
    StorageHelper.EFT_CLASS_INSTANCE_CHANGED.addField(
      FieldFormatFactory.createType(StorageHelper.FIELD_EVENT_NEW_VALUE, FieldConstants.STRING_FIELD).setNullable(true)
    );
  }
  ...
  static __static_initializer_51() {
    ...
    StorageHelper.EFT_CLASS_INSTANCE_COMMENT.addField(
      FieldFormatFactory.createType(StorageHelper.FIELD_EVENT_COMMENT, FieldConstants.STRING_FIELD)
    );
    StorageHelper.EFT_CLASS_INSTANCE_COMMENT.addBinding(
      StorageHelper.FIELD_EVENT_INSTANCE_ID,
      this.makeExpression(StorageHelper.FIELD_EVENT_INSTANCE_ID)
    );
    StorageHelper.EFT_CLASS_INSTANCE_COMMENT.addBinding(
      StorageHelper.FIELD_EVENT_AUTHOR,
      this.makeExpression(StorageHelper.FIELD_EVENT_AUTHOR)
    );
  }
  ...
  public static async getPrimaryKeyName(
    storageContext: Context<Context<any, any>, ContextManager<any>>,
