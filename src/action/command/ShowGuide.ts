...
export default class ShowGuide extends GenericActionCommand {
  ...
  public constructor(title: string | TableFormat = ShowGuide.CFT_SHOW_GUIDE, invokerContext?: string, macroName?: string) {
    super(ActionUtilsConstants.CMD_SHOW_GUIDE, title, null);
